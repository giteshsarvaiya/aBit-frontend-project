...
export default function Videocard(props) {
  return (
    ...
    <Card isFooterBlurred className=" h-[300px] w-[300px] col-span-12 sm:col-span-7 text-white-500">
      <CardHeader className="absolute z-10 top-1 flex-col items-start">
        <p className=" text-white/60 uppercase text-2xl font-bold">The Sound of Silence</p>
