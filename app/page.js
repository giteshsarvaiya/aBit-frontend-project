...
import Videocard from "@/components/navbar/videocard";
  ...
  return (
    ...
    <div className="bg-white-500 h-[100vh]">
      ...
      <main className="w-full" >
        ...
        <div className="flex w-[300px] md:w-[450px] md:h-40 h-30 rounded-xl bg-gray-500 ">
<div><img className="md:h-40 md:w-[220px] h-30 w-20 z-10 bg-cover rounded-tl-xl rounded-bl-xl border-r-2" src="https://s3-alpha-sig.figma.com/img/fa88/725b/e918233d4da7ccd1a24a48ff69f54227?Expires=1707696000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=FGLyWnTlGCGuydtH6vvOScdkyET4THiymHYdeVzff~xM6cTAPGOEw8CHlmgB4P-yy5gqMOyFb6HQfsPLP-WgYMjQ4tSkDT~YKmAjfNIe3pK-EYUyb9c2mW7XgbvLE-AV1~nGL1amZPaCocRjBNCucSVi-wfsPqGtImufYVpSksmdHtfmNnJXv5LWSiONBX9bOvpQLEoHIL0OHOYNPDuwgKzgs-8pHcDLfuHpjP66J3ffOvbVa5--FQNnE36kn3Oqlp4ohMARpDIIncllMMIYLSWMX89lXmG5MOSDQxwVUUtprZFB4D8nfd2llOu8sdIyP2Jmo-g7tIYNDFAfUvHn7A__"></img></div>
<div className="flex flex-col p-4 items-start justify-between gap-2 md:gap-0 ">
    ...
    <div className="flex flex-col items-start py-2 hidden md:flex md:flex-col"><p className="text-sm text-gray-650 font-bold" >Bio</p> <p className="text-sm text-gray-650" >Bio
...
<div className="flex border-2 w-full rounded-md" >
  ...
  <div className="w-full bg-gray-900 h-full"></div>
        ...
        <div className=" flex justify-center md:pt-36 pt-20 pb-10 ">
          <div className='w-[90vw]'>
          <div className=" flex items-center justify-start md:hidden p-4"><p className="text-sm text-gray-650 text-start font-bold" >Bio:</p> <p className="text-center text-sm text-gray-650" >
Simply a film fan creating original content for YouTube. Let’s Collaborate.
</p>   </div>
<div className="md:border-l-2 border-t-2 mt-2 border-[#9F9D9D] md:hidden "></div>
          <div className="md:flex-row flex flex-col justify-between w-full text-sm md:text-2xl">
            <div className="flex flex-col gap-2 md:justify-start justify-center p-2 md:p-0"><p className="text-center md:text-start text-3xl">Releases</p> <p className="text-center md:text-start text-[#565656] text-base ">Videos that you upload in collaboration with aBit appear here.</p></div>
